...
public class UsuarioPpal implements UserDetails {
    ...
    public UsuarioPpal(String nombre, String nombreUsuario, String email, String password, Collection<? extends GrantedAuthority> authorities) {
        this.nombre = nombre;
    ...
    public static UsuarioPpal build(Usuario usuario) {
        ...
        return new UsuarioPpal(usuario.getNombre(), usuario.getNombreUsuario(), usuario.getEmail(),
